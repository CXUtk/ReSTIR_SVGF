  ...
  AttributeData attributes : SV_IntersectionAttributes)
{
    ...
    float3 normalWS = normalize(v0.normal * barycentrics.x + v1.normal * barycentrics.y + v2.normal * barycentrics.z);
    ...
    RayDesc shadowRay;
    shadowRay.Origin = posWS + normalWS * 1e-3; 
    ...
    float NdotL = max(0, dot(normalWS, _DirectionalLightDirections[0].xyz));
